                    ...
                    <Route path="/" element={<Layout/>}>
                        ...
                        <Route path="crop/:cropName" element={<><CropType/><Outlet/></>}>
                            ...
                            <Route path="year/:yearStart/:yearEnd" element={<> <CropYear/> <Outlet/></>}>
                                ...
                                <Route path="land-preparation/*"
                                       element={<TopicDashboard element={<TableHead><LandPreparation/></TableHead>}/>}/>
                                <Route path="sowing/*"
                                       element={<TopicDashboard element={<TableHead><Sowing/></TableHead>}/>}/>
                                <Route path="inputs/*">
                                    <Route index element={<InputsCrop/>}/>
                                    <Route path="seed/*"
                                           element={<TopicDashboard element={<TableHead><Seed/></TableHead>}/>}/>
                                    <Route path="irrigation/*"
                                           element={<TopicDashboard element={<TableHead><Irrigation/></TableHead>}/>}/>
                                    <Route path="labor-management/*" element={<TopicDashboard
                                        element={<TableHead><LaborManagement/></TableHead>}/>}/>
                                    <Route path="integrated-pest-management/*" element={<TopicDashboard
                                        element={<TableHead><IntegratedPestManagement/></TableHead>}/>}/>
                                    <Route path="integrated-disease-management/*" element={<TopicDashboard
                                        element={<TableHead><IntegratedDiseaseManagement/></TableHead>}/>}/>
                                    <Route path="integrated-weed-management/*" element={<TopicDashboard
                                        element={<TableHead><IntegratedWeedManagement/></TableHead>}/>}/>
                                    <Route path="nutrient-management/*" element={<TopicDashboard
                                        element={<TableHead><NutrientManagement/></TableHead>}/>}/>
                                    <Route path="gross-inputs-cost/*" element={<TopicDashboard
                                        element={<TableHead><GrossInputsCost/></TableHead>}/>}/>
                                    <Route path="*" element={<NoMatch/>}/>
                                </Route>
                                <Route path="harvesting/*" element={<HarvestDate/>}>
                                    <Route path="*" index
                                           element={<TopicDashboard element={<TableHead><Harvesting/></TableHead>}/>}/>
                                </Route>
                                <Route path="post-harvesting-and-storage/*"
                                       element={<TopicDashboard element={<TableHead><PostHarvesting/></TableHead>}/>}/>
                                <Route path="marketing/*"
                                       element={<TopicDashboard element={<TableHead><Marketing/></TableHead>}/>}/>
                                <Route path="all-costs/*"
                                       element={<TopicDashboard element={<TableHead><AllCosts/></TableHead>}/>}/>
                                <Route path="economic-analysis/*"
                                       element={<TopicDashboard element={<EconomicAnalysis/>}/>}/>
